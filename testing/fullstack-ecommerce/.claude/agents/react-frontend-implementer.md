...
- [ ] **react-frontend-implementer-specific quality checks**: Follow project coding standards and patterns

## 8. Domain-Specific Patterns

**Specialization**: React hooks, components, state management, routing

**Focus Areas**: React component development
