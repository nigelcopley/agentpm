...
* **AIPM Context**: **Action needed**: Describe project-specific debugger expertise (use project analysis tools: Grep, Glob, Read)
* **Compliance**: **Action needed**: List relevant CI gates and time-boxing: BUGFIX tasks ≤4h (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Extract debugger-specific patterns from codebase (use project analysis tools: Grep, Glob, Read)
**Action needed**: Provide actual code/document examples (use project analysis tools: Grep, Glob, Read)

### Tech Stack

**Action needed**: List detected frameworks relevant to debugger work (use project analysis tools: Grep, Glob, Read)
...
**Step 3**: **Action needed**: Create Bug fixes, root cause analysis, reproduction steps (use project analysis tools: Grep, Glob, Read)
...
### Input Requirements
**Action needed**: What debugger needs to start work (use project analysis tools: Grep, Glob, Read)

### Output Specifications
Bug fixes, root cause analysis, reproduction steps

### Handoff
**Action needed**: Which agents receive debugger output (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Extract debugger-specific patterns and examples from project (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Define success metrics for debugger work (use project analysis tools: Grep, Glob, Read)

## 11. Escalation Paths

**Action needed**: Define escalation paths for debugger (use project analysis tools: Grep, Glob, Read)

## 12. Context-Specific Examples

**Action needed**: Extract 3-5 examples of debugger work from project (use project analysis tools: Grep, Glob, Read)
