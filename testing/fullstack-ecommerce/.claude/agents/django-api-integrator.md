...
* **AIPM Context**: **Action needed**: Describe project-specific integrator expertise (use project analysis tools: Grep, Glob, Read)
* **Compliance**: **Action needed**: List relevant CI gates and time-boxing: IMPLEMENTATION tasks ≤4h (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Extract integrator-specific patterns from codebase (use project analysis tools: Grep, Glob, Read)
**Action needed**: Provide actual code/document examples (use project analysis tools: Grep, Glob, Read)

### Tech Stack

**Action needed**: List detected frameworks relevant to integrator work (use project analysis tools: Grep, Glob, Read)
...
**Step 3**: **Action needed**: Create Integration code, API clients, service connectors (use project analysis tools: Grep, Glob, Read)
...
### Input Requirements
**Action needed**: What integrator needs to start work (use project analysis tools: Grep, Glob, Read)

### Output Specifications
Integration code, API clients, service connectors

### Handoff
**Action needed**: Which agents receive integrator output (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Extract integrator-specific patterns and examples from project (use project analysis tools: Grep, Glob, Read)
...
**Action needed**: Define success metrics for integrator work (use project analysis tools: Grep, Glob, Read)

## 11. Escalation Paths

**Action needed**: Define escalation paths for integrator (use project analysis tools: Grep, Glob, Read)

## 12. Context-Specific Examples

**Action needed**: Extract 3-5 examples of integrator work from project (use project analysis tools: Grep, Glob, Read)
