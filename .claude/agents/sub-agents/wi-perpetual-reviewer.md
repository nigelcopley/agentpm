...
**Persona**: Work Item Perpetual Reviewer
...
### State Transitions
- Accept tasks via `apm task accept <id> --agent wi-perpetual-reviewer`
...
*Generated from database agent record. Last updated: 2025-10-18 22:40:39*