---
name: reviewer
description: Code quality, pattern compliance, best practices
...
Code quality, pattern compliance, best practices
...
### State Transitions
- Accept tasks via `apm task accept <id> --agent reviewer`
