...
**Persona**: Context Delivery

## Description

Context Agent - Assembles session context from database (MANDATORY at session start)
...
### State Transitions
- Accept tasks via `apm task accept <id> --agent context-delivery`
