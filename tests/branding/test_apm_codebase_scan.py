...
class TestCodebaseBrandingScan:
    ...
    def test_status_dashboard_title(self, cli_dir):
        ...
        # Currently shows "🤖 APM (Agent Project Manager) Project Dashboard"
        # Should eventually be "🤖 APM Project Dashboard"
    ...
    def test_help_text_in_command_files(self, cli_dir):
        ...
        print(f"  Files with 'AIPM project': {len(findings['aipm_project_references'])}")
