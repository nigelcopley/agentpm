...
### Issue: Permission Denied Creating .aipm Directory

**Error**:
```
PermissionError: [Errno 13] Permission denied: '.aipm'
```
...
rm .aipm/data/aipm.db-shm
rm .aipm/data/aipm.db-wal
