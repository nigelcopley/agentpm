...
- **File-based**: Contexts (.aipm/contexts/), Agents (.claude/agents/), Documentation (docs/)
...
| Context Files (.aipm/contexts/) | 22 files | ✅ Excellent |
...
- Context files (.aipm/contexts/) - 87K lines of code analysis
...
**What**: Create resource_file context records for existing .aipm/contexts/ files
**Why**: Enable confidence tracking and freshness monitoring
**How**:
- Scan .aipm/contexts/*.txt
