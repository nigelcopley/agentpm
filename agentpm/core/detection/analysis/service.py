...
class StaticAnalysisService:
    ...
    def analyze_project(
        ...
        2. Filter using IgnorePatternMatcher (respects .gitignore, .aipmignore, default patterns)
        ...
        Args:
            ...
            exclude_patterns: DEPRECATED - Use .aipmignore file instead.
        ...
        # Step 2: Filter using IgnorePatternMatcher (respects .gitignore, .aipmignore, defaults)
