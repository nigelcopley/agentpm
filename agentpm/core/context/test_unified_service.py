...
def project_path(tmp_path):
    ...
    # Create .aipm/contexts directory
    contexts_dir = project_dir / ".aipm" / "contexts"
...
class TestUnifiedContextService:
    ...
    def test_path_traversal_prevention(self, service, sample_project, project_path):
        ...
        malicious_path = project_path / ".aipm" / "contexts" / ".." / ".." / "secrets.txt"
        ...
        # Only paths within .aipm/contexts should be included
        assert all(".aipm/contexts" in path for path in ctx.amalgamations.values())
